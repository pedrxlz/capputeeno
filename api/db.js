...
const baseProducts = [
  {
    ...
    image_url: "caneca-06.jpg",
    category: "mugs",
  },
  {
    name: "Camiseta not today.",
    description: faker.lorem.paragraph(),
    image_url: "camiseta-05.jpg",
    category: "t-shirts",
  },
  {
    name: "Caneca Black Ring",
    description: faker.lorem.paragraph(),
    image_url: "caneca-04.jpg",
    category: "mugs",
  },
  {
    name: "Camiseta Broken Saints",
    description: faker.lorem.paragraph(),
    image_url: "camiseta-03.jpg",
    category: "t-shirts",
  },
  {
    name: "Camiseta Outcast",
    description: faker.lorem.paragraph(),
    image_url: "camiseta-06.jpg",
    category: "t-shirts",
  },
  {
    name: "Caneca The Grounds",
    description: faker.lorem.paragraph(),
    image_url: "caneca-05.jpg",
    category: "mugs",
  },
  {
    name: "Camiseta evening",
    description: faker.lorem.paragraph(),
    image_url: "camiseta-02.jpg",
    category: "t-shirts",
  },
  {
    name: "Caneca preto fosco",
    description: faker.lorem.paragraph(),
    image_url: "caneca-01.jpg",
    category: "mugs",
  },
  {
    name: "Caneca Never settle",
    description: faker.lorem.paragraph(),
    image_url: "caneca-03.jpg",
    category: "mugs",
  },
  {
    name: "Camiseta DREAMER",
    description: faker.lorem.paragraph(),
    image_url: "camiseta-01.jpg",
    category: "t-shirts",
  },
  {
    name: "Caneca Decaf! P&Co",
    description: faker.lorem.paragraph(),
    image_url: "caneca-02.jpg",
    category: "mugs",
  },
  {
    name: "Camiseta Ramones",
    description: faker.lorem.paragraph(),
    image_url: "camiseta-04.jpg",
    category: "t-shirts",
  },
];
